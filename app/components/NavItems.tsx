...
const NavItems = ({isDisplay}: {isDisplay: boolean}) => {
...
// }
  ...
  return (
    <div className={isDisplay ? "absolute bg-black h-full -ml-5 transform transition-transform translate-x-0 duration-300 ease-in-out w-auto": "-translate-x-170 transform transition-transform duration-300 ease-in-out"}>
